...
const DataVsControlVsMgmt = lazy(() => import('@/Pages/MainTabs/RouteAndSwitch/Foundations/Advanced/PlanesAndTraffic/DataVsControlVsMgmt'));
const UnicastMulticastBroadcast = lazy(() => import('@/Pages/MainTabs/RouteAndSwitch/Foundations/Advanced/PlanesAndTraffic/UnicastMulticastBroadcast'));
