...
const ReqIndRespConf = lazy(() => import('@/Pages/MainTabs/RouteAndSwitch/Legacy/OSIModel/Basics/ServicePrimitives/ReqIndRespConf'));
const EncapsulationPath = lazy(() => import('@/Pages/MainTabs/RouteAndSwitch/Legacy/OSIModel/Basics/ServicePrimitives/EncapsulationPath'));
