...
const HostsAndPorts = lazy(
  () => import('@/Pages/MainTabs/RouteAndSwitch/Switching/Basics/Glossary/HostsAndPorts')
);
const L2ConceptsAndArchitecture = lazy(
  () => import('@/Pages/MainTabs/RouteAndSwitch/Switching/Basics/Glossary/L2ConceptsAndArchitecture')
);
