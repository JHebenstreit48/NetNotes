...
const LACPAndPAgP = lazy(() => import('@/Pages/MainTabs/RouteAndSwitch/Switching/Advanced/EtherChannel/LACPAndPAgP'));
const LoadBalancingAndDesign = lazy(
  () => import('@/Pages/MainTabs/RouteAndSwitch/Switching/Advanced/EtherChannel/LoadBalancingAndDesign')
);
