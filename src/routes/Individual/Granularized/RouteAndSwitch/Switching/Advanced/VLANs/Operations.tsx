...
const Trunking = lazy(
  () => import('@/Pages/MainTabs/RouteAndSwitch/Switching/Advanced/VLANs/Operations/Trunking')
);
const VTP = lazy(
  () => import('@/Pages/MainTabs/RouteAndSwitch/Switching/Advanced/VLANs/Operations/VTP')
);
