...
const SubnetMasksAndCIDR = lazy(() => import('@/Pages/MainTabs/Networking/TCPIPModel/Layers/Internet/Basics/SubnettingAndGateways/SubnetMasksAndCIDR'));
const DefaultGatewayAndRoutingTables = lazy(() => import('@/Pages/MainTabs/Networking/TCPIPModel/Layers/Internet/Basics/SubnettingAndGateways/DefaultGatewayAndRoutingTables'));
