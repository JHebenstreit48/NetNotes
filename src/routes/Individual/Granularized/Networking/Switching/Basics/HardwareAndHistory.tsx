...
const SwitchesAndConnectors = lazy(
  () => import('@/Pages/MainTabs/Networking/Switching/Basics/HardwareAndHistory/SwitchesAndConnectors')
);
const EthernetSpeedHistory = lazy(
  () => import('@/Pages/MainTabs/Networking/Switching/Basics/HardwareAndHistory/EthernetSpeedHistory')
);
