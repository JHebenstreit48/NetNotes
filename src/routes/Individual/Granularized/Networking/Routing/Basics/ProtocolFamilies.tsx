...
const DistanceVectorVsLinkState = lazy(() => import('@/Pages/MainTabs/Networking/Routing/Basics/ProtocolFamilies/DistanceVectorVsLinkState'));
const IGPVsEGP = lazy(() => import('@/Pages/MainTabs/Networking/Routing/Basics/ProtocolFamilies/IGPVsEGP'));
