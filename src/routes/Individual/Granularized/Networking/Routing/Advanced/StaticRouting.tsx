...
const ConfigurationAndUseCases = lazy(() => import('@/Pages/MainTabs/Networking/Routing/Advanced/StaticRouting/ConfigurationAndUseCases'));
const TroubleshootingAndBestPractices = lazy(() => import('@/Pages/MainTabs/Networking/Routing/Advanced/StaticRouting/TroubleshootingAndBestPractices'));
